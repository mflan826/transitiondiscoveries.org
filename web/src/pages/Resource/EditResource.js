...
const EditResource = (props) => {
  ...
  return (
    <Edit {...props}>
      <SimpleForm toolbar={<ResourceEditToolbar />} variant="outlined">
        <TextInput source="name" validate={[required()]} variant="outlined" />
        {/* <TextInput source="path" validate={[required()]} variant="outlined" /> */}
        <ImageInput
          source="thumbnail"
          label="Thumbnail"
          accept="image/*"
        ...
        <DateInput label="Publish date" source="publish_date" options={{ format: 'DD/MM/YYYY' }} />
      </SimpleForm>
    </Edit>
  );
};
